...
### Version v3.0.13 2024-08-31 - PointyBytes - Added Sonarr to the script.
...
scriptdate="2024-08-31" # change this later
...
echo ""
select app in lidarr prowlarr radarr readarr sonarr whisparr quit; do
    ...
    readarr)
        ...
        ;;
    sonarr)
        app_port="8989"                 # Default App Port for Sonarr
